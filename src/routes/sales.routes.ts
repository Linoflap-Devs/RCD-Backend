...
router.route('/distribution').get([validateEmployeeSession, validateRole(['AD','BH', 'SA', 'AL', 'ML'])], getDistributionListController);
...
router.route('/web/broker-sales/:brokerId').get([validateEmployeeSession, validateRole(['AD','BH', 'SA', 'AL', 'ML'])], getWebPersonalSalesController);
...
router.route('/web/pending/archive/:pendingSalesId').delete([validateEmployeeSession, validateRole(['AD','BH', 'SA'])], archivePendingSalesController);
...
router.route('/pending/web/archive/:pendingSalesId').delete([validateEmployeeSession, validateRole(['AD','BH', 'SA'])], archiveWebPendingSalesController);
router.route('/pending/approve/:pendingSalesId').patch([validateSession, validateRole(['SD'])], approvePendingSalesSDController);
router.route('/pending/assign/:pendingSalesId').patch([validateSession, validateRole(['SD'])], assignUMPendingSaleController);
