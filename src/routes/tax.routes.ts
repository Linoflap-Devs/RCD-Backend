...
import { addAgentTaxRatesController, deleteAgentTaxRateController, editAgentTaxRateController, getAgentTaxRateController, getAgentTaxRatesController } from '../controller/tax.controller';
...
router.route('/:agentTaxRateId').get([validateAllSessions], getAgentTaxRateController)
