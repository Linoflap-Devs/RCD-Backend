...
describe('Users Repository Test', () => {
    ...
    describe('editBrokerGovId', () => {
        it('should create a hands off broker', async () => {
            const result = await createHandsOffBroker()
        ...
        it('should edit known ID columns', async () => {
            ...
            const result = await editBrokerGovIds(1, updateData)

            expect(result.success).toBe(true)

            const verifyResult = await getBrokerGovIds(1)
